...
- **Status:** Done 2026-05-21 — `go build ./...` clean; all 20 `pkg/` packages pass; `pkg/quantization` coverage 91.4%; CHANGELOG.md `[0.17.0]` written
