...
var (
	...
	_ Layer[float32] = (*Conv2D[float32])(nil)
	_ Layer[float64] = (*Conv2D[float64])(nil)
	_ Layer[float32] = (*MaxPool2D[float32])(nil)
	_ Layer[float64] = (*MaxPool2D[float64])(nil)
	_ Layer[float32] = (*AvgPool2D[float32])(nil)
	_ Layer[float64] = (*AvgPool2D[float64])(nil)
	_ Layer[float32] = (*Flatten2D[float32])(nil)
	_ Layer[float64] = (*Flatten2D[float64])(nil)
)
